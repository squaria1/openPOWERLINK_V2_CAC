...
extern "C"
{
    ...
    // global vars
    //------------------------------------------------------------------------------
    extern uint16_t       nbValuesCN_Out;
    extern uint16_t       nbValuesCN_In;
    extern PI_IN* pProcessImageIn_l;
    extern PI_OUT* pProcessImageOut_l;
    extern int16_t* values_In_MN_l;
    extern int16_t* values_Out_MN_l;
    extern bool* activated_In_MN_l;
