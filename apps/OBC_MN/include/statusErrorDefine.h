...
typedef enum
{
	...
	errInitFirmwareManager		= 0xE20E, /**< The firmware manager to check dependances of the operating system fails to initialize. */
	errOplkSetCDCFileName		= 0xE20F, /**< The mnobd.cdc file is not found or is incorrect. */
	errSetupProcessImage		= 0xE210, /**< The input and/or output structure are not the same with what is inside the mnobd.cdc file. */
